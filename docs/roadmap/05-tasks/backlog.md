...
| UI-016 | Migração páginas para `PageShell` (`/fin/*`, `/crm`, hubs, `/vault`, `/mail`, RH parcial ✅; pendentes `/team/*`, `/hr` painéis internos, `vault/new`) | 2 | L | 🟡 | UI-011, UI-012, UI-015, UI-017 |
